                ...
                <div class="d-flex flex-column flex-md-row">
                  <div class="card-body">
                    ...
                    <form method="post" action="{{ url('/producto/update',$producto->id) }}">
                      ...
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>producto</legend> <!-- .form-group -->
                        <div class="form-group">
                          <label for="tf1">Producto</label> 
                          <input name="producto" value="{{$producto->producto}}" type="text" class="form-control"  aria-describedby="tf1Help" > 
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="tf2">cantidad</label>
                          <div class="custom-number">
                            <input name="cantidad" value="{{$producto->cantidad}}" type="number" class="form-control"  min="0" max="100" step="1"  placeholder="Amount (to the nearest dollar)">
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="tf1">precio</label> 
                          <input name="precio" value="{{$producto->precio}}" type="number" class="form-control"  aria-describedby="tf1Help"> 
                        </div><!-- /.form-group -->
                        <div>
