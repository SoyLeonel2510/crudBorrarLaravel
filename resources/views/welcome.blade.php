                    ...
                    <form method="post" action="{{ url('/save') }}">
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <input name="producto" type="text" class="form-control"  aria-describedby="tf1Help" > 
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="tf2">cantidad</label>
                          <div class="custom-number">
                            <input name="cantidad" type="number" class="form-control"  min="0" max="100" step="1" value="0" placeholder="Amount (to the nearest dollar)">
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="tf1">precio</label> 
                          <input name="precio" type="number" class="form-control"  aria-describedby="tf1Help"> 
                        </div><!-- /.form-group -->
                        <div>
